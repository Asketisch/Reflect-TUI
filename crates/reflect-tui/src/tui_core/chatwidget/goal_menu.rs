...
use super::*;
use crate::tui_core::goal_display::format_goal_elapsed_seconds;
use crate::tui_core::goal_files;
        ...
        let view = CustomPromptView::new(
            ...
            Box::new(move |objective: String| {
                tx.send(AppEvent::SetThreadGoalDraft {
                    ...
                    mode: crate::tui_core::app_event::ThreadGoalSetMode::UpdateExisting {
                        status,
                        token_budget,
                    },
                });
