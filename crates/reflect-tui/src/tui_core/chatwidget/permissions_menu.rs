...
impl ChatWidget {
    ...
    fn builtin_permission_mode_selection_item(
        ...
        let label = match (preset.id.as_str(), approvals_reviewer) {
        ...
        SelectionItem {
            ...
            disabled_reason: {
                let can_set_approval = self
                    .config
                    .permissions
                    .approval_policy
                    .can_set(&approval_policy.to_core());
                let can_set_profile = self
                    .config
                    .permissions
                ...
                if can_set_approval && can_set_profile.is_ok() && allowed {
                    None
                } else {
                    Some("Disabled by requirements.".to_string())
                }
            },
            ..Default::default()
        }
