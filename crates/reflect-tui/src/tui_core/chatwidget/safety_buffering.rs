...
use super::*;
use crate::app_server_protocol::ModelSafetyBufferingUpdatedNotification;

const SAFETY_BUFFERING_PROMPT_VIEW_ID: &str = "safety-buffering-prompt";
const SAFETY_BUFFERING_LEARN_MORE_URL: &str = "";
...
const SAFETY_BUFFERING_FOOTER: &str = "No action is required. Reflect will keep waiting, and this menu will close when the response is ready.";
