...
impl ChatWidget {
    ...
    pub(crate) fn maybe_post_pending_notification(&mut self, tui: &mut crate::tui_core::tui::Tui) {
...
impl Notification {
    ...
    pub(super) fn user_input_request_summary(
        questions: &[crate::app_server_protocol::ToolRequestUserInputQuestion],
    ) -> Option<String> {
