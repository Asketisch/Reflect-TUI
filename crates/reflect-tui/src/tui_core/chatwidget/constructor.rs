...
impl ChatWidget {
    pub(crate) fn new_with_app_event(common: ChatWidgetInit) -> Self {
        Self::new_with_op_target(common, ReflectOpTarget::AppEvent)
    }
    ...
    pub(super) fn new_with_op_target(
        ...
        let effective_service_tier =
            crate::tui_core::service_tier_resolution::effective_service_tier(
                &config,
                &header_model,
        ...
        let mut widget = Self {
            ...
            reflect_rate_limit_reached_type: None,
            reflect_spend_control_reached: None,
            ...
            ambient_pet: None,
            pet_picker_preview_state: crate::tui_core::pets::PetPickerPreviewState::default(),
        ...
        widget
            ...
            .set_windows_degraded_sandbox_active(matches!(
                crate::tui_core::windows_sandbox::level_from_config(&widget.config),
        ...
        widget
            .bottom_pane
            .set_token_activity_command_enabled(widget.has_reflect_backend_auth);
