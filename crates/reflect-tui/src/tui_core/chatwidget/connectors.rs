...
impl ChatWidget {
    ...
    fn connectors_popup_params(
        ...
        for connector in connectors {
            let connector_label = crate::connectors::metadata::connector_display_label(connector);
            ...
            let instructions = if connector.is_accessible {
                ...
                "Install this app in your browser, then reload Reflect."
            };
