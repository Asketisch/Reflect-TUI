//! `ChatWidget` 的服务档位选择与模型目录辅助函数。

use super::ChatWidget;
use crate::features::Feature;
use crate::protocol_compat::config_types::SERVICE_TIER_DEFAULT_REQUEST_VALUE;
use crate::protocol_compat::config_types::ServiceTier;
use crate::protocol_compat::openai_models::SPEED_TIER_FAST;
...
use crate::tui_core::service_tier_resolution;
...
impl ChatWidget {
    ...
    fn set_service_tier_selection(&mut self, service_tier: Option<String>) {
        ...
        self.app_event_tx
            .send(AppEvent::ReflectOp(AppCommand::override_turn_context(
                /*cwd*/ None,
