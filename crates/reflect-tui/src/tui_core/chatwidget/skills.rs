...
use crate::app_server_protocol::SkillsListEntry;
...
use crate::tui_core::bottom_pane::SkillsToggleItem;
use crate::tui_core::bottom_pane::SkillsToggleView;
use crate::tui_core::bottom_pane::popup_consts::standard_popup_hint_line;
use crate::tui_core::skills_helpers::skill_description;
...
impl ChatWidget {
    ...
    pub(crate) fn annotate_skill_reads_in_parsed_cmd(
        ...
        for parsed in &mut parsed_cmd {
            ...
            // 仅尽力而为：为从已加载技能列表中精确匹配到的 SKILL.md 路径加注。
