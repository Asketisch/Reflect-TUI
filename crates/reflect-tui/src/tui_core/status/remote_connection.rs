use crate::app_server_client::AppServerTarget;
use crate::app_server_client::RemoteAppServerEndpoint;
use url::Url;
...
mod tests {
    ...
    fn remote_connection_status_value_formats_display_value() -> color_eyre::Result<()> {
        ...
        let socket_path = AbsolutePathBuf::relative_to_current_dir("reflect.sock")?;
