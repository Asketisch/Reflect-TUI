...
use crate::tui_core::bottom_pane::footer::CollaborationModeIndicator;
use crate::tui_core::bottom_pane::footer::FooterMode;
use crate::tui_core::bottom_pane::footer::GoalStatusIndicator;
