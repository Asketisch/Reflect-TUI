...
use crate::app_server_protocol::ConfigBatchWriteParams;
use crate::app_server_protocol::ConfigWriteResponse;
...
use crate::app_server_protocol::HooksListParams;
use crate::app_server_protocol::HooksListResponse;
use crate::app_server_protocol::MergeStrategy;
    ...
    request_handle
        .request_typed(ClientRequest::ConfigBatchWrite {
            ...
            params: ConfigBatchWriteParams {
                edits: vec![crate::app_server_protocol::ConfigEdit {
